...
4. El contenido del `.gitignore` se generará instantáneamente (Puedes agregar o sacar tecnologías a gusto).  
5. Haz clic en “Copy to Clipboard” y pega el contenido en un archivo `.gitignore` dentro de tu proyecto o directamente inserta el .gitignore en la carpeta raíz del proyecto cargado.
